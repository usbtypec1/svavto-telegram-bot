...
from states.mailing import MailingToAllStates
from views.admins import AdminMenuView
from views.base import answer_view
from views.button_texts import ButtonText
from views.mailing import (
    MailingConfirmView, MailingReplyMarkupWebAppView, MailingTextInputView,
)
...
@router.callback_query(
    ...
    admins_filter,
    StateFilter(MailingToAllStates.confirm)
)
...
async def on_confirm_mailing(
    ...
    await mailing_repository.send_to_all_staff(
        text=text,
...
@router.message(
    ...
    admins_filter,
    StateFilter(MailingToAllStates.reply_markup)
)
...
@router.message(
    admins_filter,
    F.text,
    StateFilter(MailingToAllStates.text)
)
...
@router.callback_query(
    MailingTypeChooseCallbackData.filter(F.type == MailingType.ALL),
    admins_filter,
    StateFilter('*'),
)
